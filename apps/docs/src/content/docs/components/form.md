...
```ts notwoslash title="src/routes/settings/schema.ts" showLineNumbers
import { z } from "zod";
...
```ts notwoslash title="src/routes/settings/+page.server.ts" showLineNumbers
...
```svelte notwoslash title="src/routes/settings/settings-form.svelte" showLineNumbers
<script lang="ts">
...
```svelte notwoslash title="src/routes/settings/+page.svelte" showLineNumbers
<script lang="ts">
...
```ts notwoslash title="src/routes/settings/+page.server.ts" showLineNumbers {1-2,13-25}
