...
<div class="grid sm:grid-cols-2 gap-4 mt-8 sm:gap-6">
  <LinkedCard href="/docs/installation/next">
    ...
    <p class="font-medium mt-2">Next.js</p>
  </LinkedCard>
  ...
  <LinkedCard href="/docs/installation/react-router">
    ...
    <p class="font-medium mt-2">React Router</p>
  </LinkedCard>
  ...
  <LinkedCard href="/docs/installation/tanstack">
    ...
    <p class="font-medium mt-2">TanStack Start</p>
  </LinkedCard>
  <LinkedCard href="/docs/installation/gatsby">
    ...
    <p class="font-medium mt-2">Gatsby</p>
  </LinkedCard>
...
<Callout class="bg-blue-50 mt-6 border-blue-600 dark:border-blue-900 dark:bg-blue-950 mb-6 [&_code]:bg-blue-100 dark:[&_code]:bg-blue-900">
